...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', function(e) {
        ...
        // Collect form data
        const formData = {
            from_name: form.name.value,  // Name of the sender
            from_email: form.email.value,  // Email of the sender
            message: form.message.value  // Message content
        };

        console.log('Form Data:', formData);  // Debugging: Check what is being sent

        // Send email using EmailJS
        emailjs.send("portfolioservice", "portfoliotemplate", formData)
            .then((response) => {
                console.log('Success:', response); // Debugging: Check the response
